...
import com.example.app_warnet.RegisterActivity;
...
public class TambahDataUser extends AppCompatActivity {
    ...
    Button btn_tambahuser, btn_backdatauser;
                ...
                if (valid && match){
                    fAuth.createUserWithEmailAndPassword(email.getText().toString(), password.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            Toast.makeText(TambahDataUser.this, "Akun Berhasil Dibuat", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(TambahDataUser.this, "Akun Gagal Dibuat", Toast.LENGTH_SHORT).show();
                            Toast.makeText(TambahDataUser.this, "Email Sudah digunakan", Toast.LENGTH_SHORT).show();
                            Toast.makeText(TambahDataUser.this, "Atau kesalahan saat input data", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        });
        btn_backdatauser = findViewById(R.id.btn_backtambahdatauser);
        btn_backdatauser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TambahDataUser.this, AdminUserDataActivity.class);
                intent.putExtra("UserID", UserID);
                startActivity(intent);
            }
        });
    ...
    public boolean confirmPassword(EditText password, EditText confirm_password){
        ...
        if (pass1.equals(pass2)){
            ...
            Toast.makeText(TambahDataUser.this, "Password Doesn't Mactch", Toast.LENGTH_SHORT).show();
            match = false;
        }
        return match;
    }
